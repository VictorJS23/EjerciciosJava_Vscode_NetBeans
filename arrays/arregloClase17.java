...
public class arregloClase17 {
    public static void main(String[] args) {

        /*
         * "Se tienen 10 estudiantes, se necesita guardar el nombre de cada estudiante, su  *nota de acumulado, su nota de examen,y luego imprimir el promedio de notas *finales"
         */
        ...
        promedio = suma / notaFinal.length;

        System.out.println("El promedio de todas las notas finales es de: " + promedio);
